const jsonInfo = `{
  ...
  // Nesse script, utilizamos o JSON.parse() para analisar nosso json (nesse caso, uma string) e converter 
  // em um formato compatível com o JavaScript. Assim, temos mais poder sobre as informações e podemos manipulá-las
  // para, por exemplo, adicioná-las ao DOM.
